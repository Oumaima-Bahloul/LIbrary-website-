...
// SQL Join to get product details for the wishlist
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container" style="margin-top: 150px; margin-bottom: 80px;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-primary px-3 py-2"><?php echo count($wishlist_items); ?> Saved Items</span>
        </div>
        ...
        <?php if (empty($wishlist_items)): ?>
            <div class="alert alert-light border shadow-sm py-5 text-center">
                ...
                <a href="index.php" class="btn btn-primary px-4">Go Shopping</a>
            </div>
        <?php else: ?>
                    ...
                    <?php foreach ($wishlist_items as $item): ?>
                        <div class="list-group-item py-4">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h5 class="mb-1 text-capitalize fw-bold"><?php echo htmlspecialchars($item['title']); ?></h5>
                                </div>

                                <div class="col-md-2 text-md-center">
                                    <span class="text-primary fw-bold fs-5">
                                        <?php echo number_format($item['price']); ?> TND
                                    </span>
                                </div>

                                <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                    <a href="manage_cart.php?action=add&id=<?php echo $item['id']; ?>" class="btn btn-success me-2 px-3 shadow-sm">
                                        <i class="fa fa-shopping-cart me-1"></i> Add to Cart
                                    </a>
                                    <a href="toggle_wishlist.php?id=<?php echo $item['id']; ?>" class="btn btn-outline-danger border-0">
        ...
        <div class="mt-4">
            <a href="index.php" class="btn btn-link text-decoration-none text-muted">
                <i class="fa fa-arrow-left me-1"></i> Continue Browsing
            </a>
        </div>
    </div>
    <!-- newsletter -->
