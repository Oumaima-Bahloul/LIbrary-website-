  ...
  <main class="container-fluid px-5 my-5 pt-5">
    <div class="title text-center pt-5 pb-4">
      <h2 class="position-relative d-inline-block">
        Digital Library: Trends 2026
      </h2>
      <p class="text-muted">
        Discover the most anticipated new releases of the season.
      </p>
    </div>
    <div class="row g-3 justify-content-center">
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/81oydfRzeBL._AC_UF894,1000_QL80_.jpg"
              class="card-img-top"
              alt="The Women" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">Available only online</span>
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              The Women
            </h5>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">34,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=60" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=60" class="btn btn-outline-danger border-0">
            ...
            <button
              type="button"
              class="btn btn-dark w-100 mt-2 extra-small text-uppercase preview-btn"
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="The Women"
              data-author="Kristin Hannah"
              data-price="34,000 DT"
              data-img="https://m.media-amazon.com/images/I/81oydfRzeBL._AC_UF894,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://images-eu.ssl-images-amazon.com/images/I/71RPKZO2KTL._AC_UL210_SR210,210_.jpg"
              class="card-img-top"
              alt="The Familiar" />
          </div>
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">39,500 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=61" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=61" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="The Familiar"
              data-author="Leigh Bardugo"
              data-price="39,500 DT"
              data-img="https://images-eu.ssl-images-amazon.com/images/I/71RPKZO2KTL._AC_UL210_SR210,210_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/71BwgHvRwsL._AC_UF894,1000_QL80_.jpg"
              class="card-img-top"
              alt="Funny Story" />
          </div>
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">31,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=62" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=62" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Funny Story"
              data-author="Emily Henry"
              data-price="31,000 DT"
              data-img="https://m.media-amazon.com/images/I/71BwgHvRwsL._AC_UF894,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/71yocQXZOeL._AC_UF1000,1000_QL80_.jpg"
              class="card-img-top"
              alt="The Night We Met" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">#1</span>
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              The Night We Met
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">36,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=63" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=63" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="The Night We Met"
              data-author="Abby Jimenez"
              data-price="36,000 DT"
              data-img="https://m.media-amazon.com/images/I/71yocQXZOeL._AC_UF1000,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/816aj03hJgL._AC_UF894,1000_QL80_.jpg"
              class="card-img-top"
              alt="In Her Own League" />
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              In Her Own League
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">32,500 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=64" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=64" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="In Her Own League"
              data-author="Liz Tomforde"
              data-price="32,500 DT"
              data-img="https://m.media-amazon.com/images/I/816aj03hJgL._AC_UF894,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/81f1WIQgP+L._UF1000,1000_QL80_.jpg"
              class="card-img-top"
              alt="The Keeper" />
          </div>
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">42,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=65" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=65" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="The Keeper"
              data-author="Tana French"
              data-price="42,000 DT"
              data-img="https://m.media-amazon.com/images/I/81f1WIQgP+L._UF1000,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/7152BofVnpL._AC_UF1000,1000_QL80_.jpg"
              class="card-img-top"
              alt="Cool Machine" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">Hardcover</span>
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              Cool Machine
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">45,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=66" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=66" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Cool Machine"
              data-author="Colson Whitehead"
              data-price="45,000 DT"
              data-img="https://m.media-amazon.com/images/I/7152BofVnpL._AC_UF1000,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
        ...
        <div class="modal-body text-center pb-4">
          ...
          <div class="bg-light p-3 rounded mb-3">
            <p class="small text-muted mb-0">
              High-quality print with durable binding. Available for immediate
              shipping or in-store pickup.Contact us for any special requests
              or questions about our e-books. We're here to help you find the
              perfect read!
            </p>
          </div>
