...
<body>
  ...
  <main class="container-fluid px-5 my-5 pt-5" id="gifts-merch">
    <div class="title text-center pt-5 pb-4">
      <h2 class="position-relative d-inline-block text-uppercase">
        Gifts & Merch
      </h2>
      <p class="text-muted">
        Unique finds, creative bundles, and exclusive collectibles for every
        creator.
      </p>
    </div>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          ...
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted mb-2 small">Mindfulness Kids • Markers</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">70,000 DT</span>
                <span class="fw-bold text-pink">45,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=21" class="btn btn-cart border-0">
            ...
            <button
              ...
              data-title="Pack Mandalas Sea"
              data-author="Creative Mind"
              data-price="45,000 DT"
              data-img="../images/pack_kalino_mandalas_12_sea.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          ...
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted mb-2 small">
              Mindfulness • Wildlife Edition
            </p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">175,000 DT</span>
                <span class="fw-bold text-pink">129,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=22" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Wild Life Mandalas"
              data-author="Mindfulness Kids"
              data-price="129,000 DT"
              data-img="../images/mandakas_wild_life_kalino_blanc_pack.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light text-center">
            <img
              ...
              class="card-img-top p-4"
              alt="Trousse La Fleur" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 57%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Trousse La Fleur
            </h5>
            <p class="text-muted mb-2 small">Floral Design • School Pouch</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">23,000 DT</span>
                <span class="fw-bold text-pink">9,950 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=24" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Trousse La Fleur"
              data-author="Cool School"
              data-price="9,950 DT"
              data-img="../images/trousse-cool-school-bagagerie-2.webp">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light text-center">
            <img
              src="../images/pack_1.webp"
              class="card-img-top p-4"
              alt="Pack Sketch" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 28%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Pack Sketch & Dessin
            </h5>
            <p class="text-muted mb-2 small">A5 Sketchbook • 24 Colors</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">68,900 DT</span>
                <span class="fw-bold text-pink">50,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=26" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Pack Sketch & Dessin"
              data-author="Art Supplies"
              data-price="50,000 DT"
              data-img="../images/pack_1.webp"
              data-description="The ultimate beginner artist kit including a 72-sheet A5 sketchbook and artistic pencils."
              data-features="72 Feuilles A5, Crayons Artistiques, Idéal débutants">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light text-center">
            <img
              src="../images/80012672_froozen_2.webp"
              class="card-img-top p-4"
              alt="Tente Frozen" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 20%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Tente de Jeu Frozen
            </h5>
            <p class="text-muted mb-2 small">65×65×90 cm • Disney</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">33,500 DT</span>
                <span class="fw-bold text-pink">26,800 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=27" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Tente Frozen"
              data-author="Disney"
              data-price="26,800 DT"
              data-img="../images/80012672_froozen_2.webp"
              data-description="Official Disney Frozen themed indoor play tent. Lightweight and easy to assemble."
              data-features="Montage rapide, Lavable en surface, Thème Officiel">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          ...
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted mb-2 small">Travel Size • Age 6+</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start text-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">69,900 DT</span>
                <span class="fw-bold text-pink">62,900 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=28" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Chess Set"
              data-author="Tabletop Classics"
              data-price="62,900 DT"
              data-img="../images/chess-magnetic-game-age-6-jouets.webp">
              View Details
            </button>
          </div>
        </div>
