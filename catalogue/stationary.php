...
<body>
  ...
  <main class="container-fluid px-5 my-5 pt-5">
    <div class="title text-center pt-5 pb-4">
      ...
      <p class="text-muted">
        The perfect tools for your thoughts, sketches, and daily plans.
      </p>
    </div>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://www.graphicimage.com/cdn/shop/files/AJL-TIM-BCH-OPEN-26.jpg?v=1751998774"
              class="card-img-top p-4"
              alt="2026 Daily Planner" />
            <span
              class="position-absolute top-0 start-0 bg-warning text-dark px-2 py-1 m-2 extra-small fw-bold">2026 Edition</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Minimalist Daily Planner
            </h5>
            <p class="text-muted mb-2 small">Linen Cover • 120gsm Paper</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">45,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=73" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=73" class="btn btn-outline-danger border-0">
            ...
            <button
              ...
              data-title="Minimalist Daily Planner"
              data-author="Organization"
              data-price="45,000 DT"
              data-img="https://www.graphicimage.com/cdn/shop/files/AJL-TIM-BCH-OPEN-26.jpg?v=1751998774">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://images-na.ssl-images-amazon.com/images/I/61JU4aWt0YL._SS400_.jpg"
              class="card-img-top p-4"
              alt="Modern Fountain Pen" />
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Matte Black Fountain Pen
            </h5>
            <p class="text-muted mb-2 small">Fine Nib • Refillable Ink</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">32,500 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=74" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=74" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Matte Black Fountain Pen"
              data-author="Writing Tools"
              data-price="32,500 DT"
              data-img="https://images-na.ssl-images-amazon.com/images/I/61JU4aWt0YL._SS400_.jpg">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://ap.filofax.com/cdn/shop/products/132814__open.webp?v=1673286284"
              class="card-img-top p-4"
              alt="Washi Tape Set" />
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Botanical Washi Tape Set
            </h5>
            <p class="text-muted mb-2 small">3 Rolls</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">22,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=75" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=75" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Botanical Washi Tape Set"
              data-author="Crafts"
              data-price="22,000 DT"
              data-img="https://ap.filofax.com/cdn/shop/products/132814__open.webp?v=1673286284">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="../images/fluo.webp"
              class="card-img-top p-4"
              alt="Highlighters" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 25%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              4 Surligneurs Fluorescents
            </h5>
            <p class="text-muted mb-2 small">Assorted Neon Colors</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">15,900 DT</span>
                <span class="fw-bold text-pink">12,040 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=10" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Coffret 4 Surligneurs"
              data-author="Writing"
              data-price="12,040 DT"
              data-img="../images/fluo.webp">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          ...
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Agenda Quotidien Structuré
            </h5>
            <p class="text-muted mb-2 small">21 × 15 cm • Elegant</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">24,500 DT</span>
                <span class="fw-bold text-pink">18,500 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=9" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Agenda Quotidien"
              data-author="Organization"
              data-price="18,500 DT"
              data-img="../images/agenda.webp">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="../images/coffret stylo.webp"
              class="card-img-top p-4"
              alt="Art Set" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 55%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Coffret 60 Crayons CarbOthello
            </h5>
            <p class="text-muted mb-2 small">Professional Pastel Pencils</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">327,500 DT</span>
                <span class="fw-bold text-pink">147,375 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=11" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Coffret CarbOthello"
              data-author="Stabilo"
              data-price="147,375 DT"
              data-img="../images/coffret stylo.webp">
              View Details
            </button>
          </div>
        </div>
