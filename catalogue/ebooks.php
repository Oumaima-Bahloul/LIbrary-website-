    ...
    <div class="row g-3 justify-content-center">
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/81kg51XRc1L._AC_UF1000,1000_QL80_.jpg"
              class="card-img-top"
              alt="Atomic Habits" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">PDF</span>
          </div>
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=55" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=55" class="btn btn-outline-danger border-0">
            ...
            <button
              ...
              data-img="https://m.media-amazon.com/images/I/81kg51XRc1L._AC_UF1000,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              ...
              alt="It Ends With Us" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">EPUB</span>
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              It Ends With Us
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">38,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=56" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=56" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-author="Colleen Hoover"
              data-price="38,000 DT"
              data-img="https://m.media-amazon.com/images/I/91CqNElQaKL._AC_UF1000,1000_QL80_.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/81JJPDNlxSL.jpg"
              class="card-img-top"
              alt="Silent Patient" />
            <span
              class="position-absolute top-0 start-0 bg-primary text-white px-2 py-1 m-2 extra-small">Kindle</span>
          </div>
          <div class="card-body text-center p-2">
            <h5 class="card-title mb-1" style="font-size: 0.85rem">
              The Silent Patient
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=57" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=57" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-img="https://m.media-amazon.com/images/I/81JJPDNlxSL.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          ...
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold text-pink small">22,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=58" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=58" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-img="https://m.media-amazon.com/images/I/71aFt4+OTOL.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative">
            <img
              src="https://m.media-amazon.com/images/I/81gC3mdNi5L._AC_UF350,350_QL50_.jpg"
              class="card-img-top"
          ...
          <div class="card-body text-center p-2">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=59" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=59" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-img="https://m.media-amazon.com/images/I/81gC3mdNi5L._AC_UF350,350_QL50_.jpg">
              Preview
            </button>
          </div>
        </div>
        ...
        <div class="modal-body text-center pb-4">
          ...
          <div class="bg-light p-3 rounded mb-3">
            <p class="small text-muted mb-0">
              High-quality digital edition. Available in PDF, EPUB, and Kindle
              formats immediately after purchase.Contact us for any special
              requests or questions about our e-books. We're here to help you
