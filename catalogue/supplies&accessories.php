...
<body>
  ...
  <main class="container-fluid px-5 my-5 pt-5">
    <div class="title text-center pt-5 pb-4">
      ...
      <p class="text-muted">
        Premium accessories to elevate your reading experience.
      </p>
    </div>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://m.media-amazon.com/images/I/71uNUqlJ8jL._AC_SL1500_.jpg"
              class="card-img-top p-4"
              alt="LED Reading Light" />
            <span
              class="position-absolute top-0 start-0 bg-warning text-dark px-2 py-1 m-2 extra-small fw-bold">Top Rated</span>
          </div>
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted mb-2 small">
              Adjustable Warmth & Brightness
            </p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">28,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=70" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=70" class="btn btn-outline-danger border-0">
            ...
            <button
              ...
              data-title="Rechargeable LED Book Light"
              data-author="supplies&accessories"
              data-price="28,000 DT"
              data-img="https://m.media-amazon.com/images/I/71uNUqlJ8jL._AC_SL1500_.jpg">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://m.media-amazon.com/images/I/81cbZMwzvJL._AC_UF894,1000_QL80_.jpg"
              class="card-img-top p-4"
              alt="Golden Feather Bookmark" />
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Golden Feather Bookmark
            </h5>
            <p class="text-muted mb-2 small">Handcrafted Brass</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">12,500 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=71" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=71" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Golden Feather Bookmark"
              data-author="supplies&accessories"
              data-price="12,500 DT"
              data-img="https://m.media-amazon.com/images/I/81cbZMwzvJL._AC_UF894,1000_QL80_.jpg">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="https://outofprint.com/cdn/shop/files/TOTE-1131-Tote-Just-One-More-Chapter-01_1200x1600.jpg?v=1710775544"
              class="card-img-top p-4"
              alt="Library Tote Bag" />
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              "Just One More Chapter" Tote
            </h5>
            <p class="text-muted mb-2 small">100% Organic Cotton</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">22,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=72" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=72" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Library Tote Bag"
              data-author="supplies&accessories"
              data-price="22,000 DT"
              data-img="https://outofprint.com/cdn/shop/files/TOTE-1131-Tote-Just-One-More-Chapter-01_1200x1600.jpg?v=1710775544">
              View Details
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              src="../images/stylos.webp"
              class="card-img-top p-4"
              alt="STABILO POINT 88" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 35%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              STABILO POINT 88 ROLLERSET
            </h5>
            <p class="text-muted mb-2 small">Premium Fineliner Set</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">75,000 DT</span>
                <span class="fw-bold text-pink">48,750 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=12" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="STABILO POINT 88"
              data-author="supplies&accessories"
              data-price="48,750 DT"
              data-img="../images/stylos.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              ...
              alt="Stapler" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 10%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              STD Popular S-80 Stapler
            </h5>
            <p class="text-muted mb-2 small">Full Strip Plastic</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">10,000 DT</span>
                <span class="fw-bold text-pink">9,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=13" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="STD Stapler"
              data-author="supplies&accessories"
              data-price="9,000 DT"
              data-img="../images/aggra.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              ...
              alt="Calculator" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 30%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Casio Graphing Calculator
            </h5>
            <p class="text-muted mb-2 small">With Python Support</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">450,000 DT</span>
                <span class="fw-bold text-pink">315,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=14" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Casio Calculator"
              data-author="supplies&accessories"
              data-price="315,000 DT"
              data-img="../images/cal.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm">
          <div class="position-relative bg-light">
            <img
              ...
              alt="Loupe" />
            <span
              class="position-absolute top-0 start-0 bg-pink text-white px-2 py-1 m-2 extra-small fw-bold">SALE 26%</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 0.95rem">
              Foska Magnifying Glass
            </h5>
            <p class="text-muted mb-2 small">100mm Professional Loupe</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <div class="d-flex flex-column align-items-start">
                <span
                  class="text-muted extra-small text-decoration-line-through">13,550 DT</span>
                <span class="fw-bold text-pink">10,000 DT</span>
              </div>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=15" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>
            ...
            <button
              ...
              data-bs-toggle="modal"
              data-bs-target="#previewModal"
              data-title="Foska Metal Magnifying Glass"
              data-author="supplies&accessories"
              data-price="10,000 DT"
              data-img="../images/loupe.webp">
              View Details
            </button>
          </div>
        </div>
        ...
        <div class="modal-body text-center pb-4">
          ...
          <div class="bg-light p-3 rounded mb-3">
            <p class="small text-muted mb-0">
              ...
              produts. We're here to help you find the perfect read!
            </p>
          </div>
