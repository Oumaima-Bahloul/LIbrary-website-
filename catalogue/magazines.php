...
<body>
  ...
  <main class="container-fluid px-5 my-5 pt-5">
    <div class="title text-center pt-5 pb-4">
      ...
      <p class="text-muted">
        Fresh arrivals: Exploring the latest in tech, fashion, and culture.
      </p>
    </div>
    <div class="row g-4 justify-content-center">
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm overflow-hidden">
          <div class="position-relative">
            <img
              src="https://ngsingleissues.nationalgeographic.com/media/catalog/product/cache/d24a34bded6d2df740ef66d66d2112c9/n/g/ngm_apr_2026.jpg"
              class="card-img-top"
              alt="National Geographic" />
            <span
              class="position-absolute top-0 end-0 bg-danger text-white px-3 py-1 m-2 small fw-bold">New Issue</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 1rem">
              National Geographic
            </h5>
            <p class="text-muted mb-2 small">April 2026 Edition</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">50,500 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=67" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=67" class="btn btn-outline-danger border-0">
            ...
            <button
              ...
              data-author="April 2026 Edition"
              data-price="50,500 DT"
              data-img="https://ngsingleissues.nationalgeographic.com/media/catalog/product/cache/d24a34bded6d2df740ef66d66d2112c9/n/g/ngm_apr_2026.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm overflow-hidden">
          <div class="position-relative">
            <img
              src="https://assets.vogue.com/photos/698a07550541cfec002af4a3/master/w_1600%2Cc_limit/VO0326_SocialCover.jpg"
              class="card-img-top"
              alt="Vogue" />
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 1rem">Vogue</h5>
            <p class="text-muted mb-2 small">Spring Fashion Issue</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">150,000 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=68" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=68" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-bs-target="#previewModal"
              data-title="Vogue"
              data-author="Spring Fashion Issue"
              data-price="150,000 DT"
              data-img="https://assets.vogue.com/photos/698a07550541cfec002af4a3/master/w_1600%2Cc_limit/VO0326_SocialCover.jpg">
              Preview
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm overflow-hidden">
          <div class="position-relative">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1491Ykzfjaj8TiMP7p1RzfPJmztlkSxOB0g&s"
              class="card-img-top"
              alt="Wired" />
            <span
              class="position-absolute top-0 start-0 bg-dark text-white px-2 py-1 m-2 extra-small">Bestseller</span>
          </div>
          <div class="card-body text-center p-3">
            <h5 class="card-title mb-1" style="font-size: 1rem">Wired</h5>
            <p class="text-muted mb-2 small">Future of AI Special</p>
            <div
              class="d-flex justify-content-between align-items-center mb-3">
              <span class="fw-bold text-pink">14,200 DT</span>
              <div class="d-flex">
                <!-- CART LINK -->
                <a href="../manage_cart.php?action=add&id=69" class="btn btn-cart border-0">
                  <i class="bi bi-basket"></i>
                </a>

                <!-- WISHLIST LINK -->
                <a href="../toggle_wishlist.php?id=69" class="btn btn-outline-danger border-0">
                  <i class="bi bi-heart"></i>
                </a>
              </div>
            </div>
            <button
              ...
              data-bs-target="#previewModal"
              data-title="Wired"
              data-author="Future of AI Special"
              data-price="14,200 DT"
              data-img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1491Ykzfjaj8TiMP7p1RzfPJmztlkSxOB0g&s">
              Preview
            </button>
          </div>
        </div>
        ...
        <div class="modal-body text-center pb-4">
          ...
          <div class="bg-light p-3 rounded mb-3">
            <p class="small text-muted mb-0">
              ...
              or questions about our products. We're here to help you find the
              perfect read!
            </p>
          </div>
