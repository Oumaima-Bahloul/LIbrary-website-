...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="container mt-5 pt-5">
    <div class="title text-center py-5">
      <h2 class="position-relative d-inline-block text-uppercase fw-bold">
        La Fleur Blog
      </h2>
      <p class="text-muted">
        Stories, Events, and Inspiration from our Bookstore
      </p>
    </div>

    <div class="row g-5">
      <div class="col-lg-8">
        <article class="card mb-4 border-0 shadow-sm overflow-hidden">
          <div class="row g-0">
            <div class="col-md-5">
              <img
            ...
            <div class="col-md-7">
              <div class="card-body p-4">
                <span class="badge bg-pink mb-2">Events</span>
                <h3 class="card-title h4">Children’s Science Lab</h3>
                <p class="text-muted small mb-2">
                  <i class="bi bi-calendar3 me-1"></i> May 15, 2026 | By Admin
                </p>
                <p class="card-text">
                  Hands-on science experiments for kids hosted by Professor
                  Lina Youssef. We explore chemistry, physics, and biology in
                  a fun, safe environment...
                </p>
                <a href="#" class="btn btn-dark btn-sm text-uppercase">Read Full Story</a>
              </div>
            </div>
          </div>
        </article>
        ...
        <article class="card mb-4 border-0 shadow-sm overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-7">
              <div class="card-body p-4">
                <span class="badge bg-pink mb-2">Community</span>
                <h3 class="card-title h4">Storytime with Local Authors</h3>
                <p class="text-muted small mb-2">
                  <i class="bi bi-calendar3 me-1"></i> June 02, 2026 | By La
                  Fleur
                </p>
                <p class="card-text">
                  Join us for an afternoon of storytelling with celebrated
                  local authors. It's a unique chance for kids to meet the
                  creators behind their favorite books...
                </p>
                <a href="#" class="btn btn-dark btn-sm text-uppercase">Read Full Story</a>
              </div>
            </div>
        ...
        <article class="card mb-4 border-0 shadow-sm overflow-hidden">
          <div class="row g-0">
            ...
            <div class="col-md-7">
              <div class="card-body p-4">
                <span class="badge bg-pink mb-2">Culture</span>
                <h3 class="card-title h4">Poetry & Coffee Nights</h3>
                <p class="text-muted small mb-2">
                  <i class="bi bi-calendar3 me-1"></i> June 10, 2026 | By Art
                  Dept
                </p>
                <p class="card-text">
                  Sip coffee while enjoying live poetry readings by emerging
                  poets. Our community open mic sessions are officially back
                  every Friday night...
                </p>
                <a href="#" class="btn btn-dark btn-sm text-uppercase">Read Full Story</a>
              </div>
        ...
        <nav aria-label="Blog navigation" class="mt-5">
          <ul class="pagination justify-content-center">
            <li class="page-item disabled">
              <a class="page-link border-0 shadow-sm mx-1" href="#">Previous</a>
            </li>
            <li class="page-item active">
              <a class="page-link border-0 shadow-sm mx-1 bg-pink" href="#">1</a>
            </li>
            <li class="page-item">
              <a class="page-link border-0 shadow-sm mx-1 text-dark" href="#">2</a>
            </li>
            <li class="page-item">
              <a class="page-link border-0 shadow-sm mx-1 text-dark" href="#">Next</a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <div class="col-lg-4">
        <div class="card border-0 shadow-sm p-4 mb-4">
          <h5 class="text-uppercase fw-bold mb-3">Search Blog</h5>
        ...
        <div class="card border-0 shadow-sm p-4">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="#" class="text-decoration-none text-muted d-block py-1">New Arrivals <span class="float-end">(12)</span></a>
            </li>
            <li>
              <a href="#" class="text-decoration-none text-muted d-block py-1">Events <span class="float-end">(5)</span></a>
            </li>
            <li>
              <a href="#" class="text-decoration-none text-muted d-block py-1">Workshops <span class="float-end">(8)</span></a>
            </li>
            <li>
              <a href="#" class="text-decoration-none text-muted d-block py-1">Reviews <span class="float-end">(21)</span></a>
            </li>
          </ul>
        </div>
      </div>
