...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="container mt-5 pt-5">
    <div class="row align-items-center py-5">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img
          ...
          alt="La Fleur Bookstore Interior"
      ...
      <div class="col-lg-6 ps-lg-5">
        <div class="title mb-4">
          ...
          <div class="bg-pink mt-1" style="height: 3px; width: 60px"></div>
        </div>
        <p class="lead text-muted">
          Born from a passion for paper and ink,
          <span class="text-pink fw-bold">La Fleur</span> is more than just a
          bookstore.
        </p>
        <p>
          Since our founding, we have aimed to cultivate a sanctuary for
          thinkers, dreamers, and creators. We believe that every book is a
          seed, and every reader is a garden. Our curated collection spans
          from timeless classics to modern masterpieces, alongside a unique
          selection of creative tools and gifts.
        </p>
        <p>
          Located in the heart of the community, we strive to foster a love
          for reading and provide a space where creativity can truly bloom.
        </p>
      </div>
    </div>
    ...
    <div class="row text-center g-4">
      <div class="col-md-4">
        <div class="p-4 border-0 shadow-sm card h-100">
          <div class="display-5 text-pink mb-3">
            <i class="bi bi-book"></i>
          </div>
          <h4 class="text-uppercase">Curated Selection</h4>
          <p class="text-muted small">
            We hand-pick every title and product to ensure the highest quality
      ...
      <div class="col-md-4">
        <div class="p-4 border-0 shadow-sm card h-100">
          ...
          <h4 class="text-uppercase">Community First</h4>
          <p class="text-muted small">
            From local workshops to reading clubs, we are dedicated to
      ...
      <div class="col-md-4">
        <div class="p-4 border-0 shadow-sm card h-100">
          ...
          <h4 class="text-uppercase">Creative Spirit</h4>
          <p class="text-muted small">
            We support the arts by offering exclusive merch and bundles that
    ...
    <div class="row mt-5 pt-5 mb-5 justify-content-center">
      <div class="col-lg-8 text-center bg-light p-5 rounded shadow-sm">
        ...
        <blockquote class="blockquote">
          <p class="mb-0 italic text-muted">
            "To nurture the mind and inspire the soul by making the world of
            literature and art accessible to everyone."
          </p>
        </blockquote>
      </div>
    </div>
