...
<body class="d-flex flex-column min-vh-100">
    ...
    $o_stmt = $pdo->prepare("SELECT * FROM orders WHERE id = ? AND user_name = ?");
    $o_stmt->execute([$order_id, $_SESSION['user_name']]);
    $order = $o_stmt->fetch();
    ...
    SELECT oi.quantity, oi.price_at_purchase,
           p.title, p.author, p.image, p.category
    FROM order_items oi
...
");
    ...
    <!--nav bar end-->
    <main class="flex-grow-1 bg-light" style="padding-top: 110px;">
        <div class="container py-5">

            <!-- Back button + title -->
            <div class="d-flex align-items-center gap-3 mb-5">
                <a href="my-orders.php" class="btn rounded-pill border" style="color: var(--pink);">
                    <i class="bi bi-arrow-left me-1"></i> Back to Orders
                </a>
                <div class="title">
                    <h2 class="position-relative d-inline-block ms-4 mb-0" style="font-family: var(--lg-font);">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 p-4">
                        <h5 class="fw-bold mb-4" style="font-family: var(--lg-font);">Order Summary</h5>
                        <ul class="list-unstyled text-muted small">
                            <li class="mb-3 d-flex justify-content-between">
                                <span><i class="bi bi-calendar3 me-2"></i> Date</span>
                                <strong class="text-dark"><?php echo date('M d, Y', strtotime($order['order_date'])); ?></strong>
                            </li>
                            <li class="mb-3 d-flex justify-content-between">
                                <span><i class="bi bi-person me-2"></i> Name</span>
                                <strong class="text-dark"><?php echo htmlspecialchars($order['user_name']); ?></strong>
                            </li>
                            <?php if ($order['phone']): ?>
                                <li class="mb-3 d-flex justify-content-between">
                                    <span><i class="bi bi-telephone me-2"></i> Phone</span>
                                    <strong class="text-dark"><?php echo htmlspecialchars($order['phone']); ?></strong>
                                </li>
                            <?php endif; ?>
                            <?php if ($order['address']): ?>
                                <li class="mb-3 d-flex justify-content-between">
                                    <span><i class="bi bi-geo-alt me-2"></i> Address</span>
                                    <strong class="text-dark"><?php echo htmlspecialchars($order['address']); ?></strong>
                                </li>
                            <?php endif; ?>
                            <li class="mb-3 d-flex justify-content-between">
                                <span><i class="bi bi-tag me-2"></i> Status</span>
                                <?php
                                ...
                                ?>
                                <span class="badge rounded-pill <?php echo $badge; ?>"><?php echo $order['status']; ?></span>
                            </li>
                        </ul>
                        <hr>
                        <div class="d-flex justify-content-between fw-bold fs-5">
                            <span>Total</span>
                            <span style="color: var(--pink);"><?php echo number_format($order['total_price']); ?> DT</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm rounded-4 p-4">
                        <h5 class="fw-bold mb-4" style="font-family: var(--lg-font);">Items Ordered</h5>
                                ...
                                <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                                    ...
                                    <?php else: ?>
                                        <div class="d-flex align-items-center justify-content-center bg-light rounded"
                                            ...
                                            <i class="bi bi-book text-muted fs-3"></i>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <?php if ($item['author']): ?>
                                            <div class="text-muted small"><?php echo htmlspecialchars($item['author']); ?></div>
                                        <?php endif; ?>
                                    ...
                                    <div class="text-end">
                                        ...
                                        <div class="fw-bold" style="color: var(--pink);">
                                            <?php echo number_format($item['price_at_purchase'] * $item['quantity']); ?> DT
                                        </div>
                                        <div class="text-muted small"><?php echo number_format($item['price_at_purchase']); ?> DT each</div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
