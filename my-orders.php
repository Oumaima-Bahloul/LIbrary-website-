...
<body class="d-flex flex-column min-vh-100">
    ...
    // Orders
    // Get email from DB using the session user_name
    $o_stmt = $pdo->prepare("SELECT * FROM orders WHERE user_name = ? ORDER BY order_date DESC");
    $o_stmt->execute([$_SESSION['user_name']]);
        ...
        <div class="container py-5">
                        ...
                        <tbody>
                            <?php foreach ($orders as $order): ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format($order['total_price'], 3); ?> DT</td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="badge rounded-pill <?php echo $badge; ?>">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <h4 class="mt-3 fw-bold" style="font-family: var(--lg-font);">
                        You haven't placed any orders yet.
                    </h4>
                    <p class="text-muted">Browse our collection and find something you love!</p>
                    <a href="index.php" class="btn rounded-pill text-white mt-2"
                        style="background-color:var(--pink); border-color:var(--pink); padding: 10px 30px;">
                        Start Shopping
                    </a>
                </div>
            <?php endif; ?>
