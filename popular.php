...
<body class="d-flex flex-column min-vh-100">
  ...
  <main class="container mt-5 pt-5">
    <div class="title text-center py-5">
      ...
      <p class="text-muted">The items our community is loving right now.</p>
    </div>
    ...
    <div class="row g-4">
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm position-relative">
          ...
          <div class="bg-light p-4 rounded-top text-center">
            <img
              src="catalogue/pics/jujutsu-kaisen-tome-15-le-drame-de-shibuya-transformation.jpg"
              class="img-fluid"
              alt="Bestseller 1"
          ...
          <div class="card-body text-center p-3">
            <p class="text-uppercase extra-small text-pink fw-bold mb-1">
              Bestseller
            </p>
            <h5 class="card-title h6">
              Jujutsu Kaisen Tome 15 - Le drame de Shibuya : transformation
            </h5>
            <p class="text-muted small mb-3">Gege Akutami</p>
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold fs-5 text-dark">28,500 DT</span>
              <!-- CART LINK -->
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm position-relative">
          ...
          <div class="card-body text-center p-3">
            ...
            <h5 class="card-title h6">Rechargeable LED Book Light</h5>
            <p class="text-muted small mb-3">
              Adjustable Warmth & Brightness
            </p>
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold fs-5 text-dark">28,000 DT</span>
              <!-- CART LINK -->
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm position-relative">
          ...
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted small mb-3">J. K. Rowling</p>
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold fs-5 text-dark">43,500 DT</span>
              <!-- CART LINK -->
      ...
      <div class="col-6 col-md-4 col-lg-3">
        <div class="card h-100 border-0 shadow-sm position-relative">
          ...
          <div class="card-body text-center p-3">
            ...
            <p class="text-muted small mb-3">A4 Dotted Paper</p>
            <div class="d-flex justify-content-between align-items-center">
              <span class="fw-bold fs-5 text-dark">18,500 DT</span>
              <!-- CART LINK -->
    ...
    <div class="row mt-5 pt-5 mb-5">
      <div class="col-12 text-center bg-dark text-white p-5 rounded">
        <h3 class="text-uppercase mb-3">Can't decide?</h3>
        <p class="mb-4">
          Check out our large book collection for the best value.
        </p>
        <a href="catalogue/books.php" class="btn btn-outline-light px-4">Browse our books</a>
      </div>
    </div>
  </main>
  <!-- footer -->
