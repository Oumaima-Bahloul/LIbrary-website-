    ...
    <main class="flex-grow-1 bg-light" style="padding-top: 110px;">
        <div class="container py-5">
            ...
            <div class="title mb-5">
                <h2 class="position-relative d-inline-block ms-4" style="font-family: var(--lg-font);">
                    My Profile
                </h2>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 text-center p-4">
                        <div class="mx-auto mb-3 d-flex align-items-center justify-content-center rounded-circle"
                            style="width:90px;height:90px;background-color:#f8e6f3;">
                            <i class="bi bi-person-fill" style="font-size:2.5rem;color:var(--pink);"></i>
                        </div>
                        <h5 class="fw-bold mb-0" style="font-family: var(--lg-font);">
                        ...
                        <div class="d-flex justify-content-around text-center mt-2">
                            <a href="wishlist.php" class="text-decoration-none">
                                <div class="fw-bold" style="color:var(--pink); font-size:1.3rem;">
                                    <?php echo $wish_count; ?>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow-sm rounded-4 p-4">
                        <h5 class="fw-bold mb-4" style="font-family: var(--lg-font);">Personal Information</h5>
                        ...
                        <form action="api/update-profile.php" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="address" class="form-control rounded-3" rows="3"><?php echo htmlspecialchars($user['address'] ?? ''); ?></textarea>
                            </div>

                            <hr class="mb-4">
                            <h5 class="fw-bold mb-3" style="font-family: var(--lg-font);">Change Password</h5>

                            <div class="mb-3">
                                <label class="form-label text-muted small fw-bold text-uppercase">New Password</label>
                                <input type="password" name="new_password" class="form-control rounded-3" placeholder="Leave blank to keep current password">
                            </div>

                            <div class="mb-4">
                                <label class="form-label text-muted small fw-bold text-uppercase">Confirm New Password</label>
                                <input type="password" name="confirm_password" class="form-control rounded-3" placeholder="Repeat new password">
                            </div>

                            <button type="submit" class="btn w-100 py-2 fw-bold text-white rounded-pill"
                                style="background-color:var(--pink); border-color:var(--pink);">
                                Save Changes
                            </button>
